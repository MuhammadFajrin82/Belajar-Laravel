...
<body>
    <div class="container">
      <h1 class="mt-5">UNIVERSITAS SULAWESI BARAT</h1>
        ...
        @csrf
           <div class="form-group clas mt-5">
    <label for="exampleInputPassword">Nidn</label>
    <input type="text" name="nidn" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your Nidn">
